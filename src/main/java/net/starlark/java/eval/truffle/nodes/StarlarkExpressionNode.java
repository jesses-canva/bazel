...
/** Base class for all Starlark expression nodes in the Truffle AST. */
public abstract class StarlarkExpressionNode extends Node {
    ...
    /** Executes this expression and returns its value. */
