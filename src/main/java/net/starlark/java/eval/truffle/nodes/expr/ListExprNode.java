...
/** List literal expression node: evaluates {@code [e1, e2, ...]}. */
public final class ListExprNode extends StarlarkExpressionNode {

  @Children private final StarlarkExpressionNode[] elements;

  public ListExprNode(StarlarkExpressionNode[] elements) {
  ...
  public Object executeGeneric(VirtualFrame frame) {
    ...
    return StarlarkTruffleAccessor.wrapList(thread.mutability(), values);
  }
}
