...
public final class ShortCircuitOrNode extends StarlarkExpressionNode {

  @Child private StarlarkExpressionNode left;
  @Child private StarlarkExpressionNode right;
  private final ConditionProfile profile = ConditionProfile.createCountingProfile();

  public ShortCircuitOrNode(StarlarkExpressionNode left, StarlarkExpressionNode right) {
    this.left = left;
    this.right = right;
  }
